...
class TreeTests(TestCase):
    ...
    def test_sequence_nodes(self):
        ...
        s = Sequence(Literal('heigh', kind='greeting1'),
                     Literal('ho',    kind='greeting2'), kind='dwarf')
        text = 'heighho'
    ...
    def test_one_of(self):
        ...
        o = OneOf(Literal('a', kind='lit'), kind='one_of')
        text = 'aa'
    ...
    def test_optional(self):
        ...
        expr = Optional(Literal('a', kind='lit'), kind='opt')
    ...
    def test_zero_or_more_zero(self):
        ...
        expr = ZeroOrMore(Literal('a'), kind='zero')
        text = ''
    ...
    def test_one_or_more_one(self):
        ...
        expr = OneOrMore(Literal('a', kind='lit'), kind='one')
        text = 'a'
...
class ParseTests(TestCase):
    ...
    def test_parse_success(self):
        ...
        """
        expr = OneOrMore(Literal('a', kind='lit'), kind='more')
        text = 'aa'
